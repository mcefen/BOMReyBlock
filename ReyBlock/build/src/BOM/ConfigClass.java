...
public class ConfigClass extends DataBaseClass{
    ...
    public static String [] configReader (){
        ...
        String [] datosReturn = {datos[0],datos[1],datos[2],datos[3],dataFromDB[0],dataFromDB[1],dataFromDB[2],datos[4],dataFromDB[3],dataFromDB[4],dataFromDB[5],dataFromDB[6]};
        return datosReturn;
    }
    ...
    public static String [] configReaderInit(){
        ...
        if (fileExists()){
            try {
                ...
                System.out.println("Error en leer archivo Config.txt \n"+e);
                ...
                try {
                    ...
                    System.out.println("Error en cerrar archivo Config.txt \n"+e2);
                }
            }
        }
        else {
    ...
    public static String[] getDataFromConfiguracion(){
        ...
        try {
                ...
                resultSet = st.executeQuery("SELECT * FROM configuracion;");

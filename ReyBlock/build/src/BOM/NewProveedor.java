...
public class NewProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nameframe.setText("Nuevo Proveedor");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(nameframe, javax.swing.GroupLayout.PREFERRED_SIZE, 347, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void Insertar() throws FileNotFoundException {
        try {
            ...
            ps = (PreparedStatement) connection.prepareStatement("INSERT INTO proveedor (Nombre,Direccion,Telefono) values (?,?,?)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(NewProveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
